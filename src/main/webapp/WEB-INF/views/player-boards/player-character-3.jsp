<!-- PLAYER 3 -->
			<div class="col-sm-6">
				<div class="card text-center">
					<h4 class="card-title card-title-bold">Player 3 <img class="img-fluid mx-auto d-block char-3"
					...
					<div class="card-body">
						...
						<button class="btn btn-square btn-danger red-lock3" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-warning yellow-lock3" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-success green-lock3" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-primary blue-lock3" data-toggle="button"><i class="fa fa-lock"></i></button>
