<!-- PLAYER 5 -->
			<div class="col-sm-6">
				<div class="card text-center">
					<h4 class="card-title card-title-bold">Player 5 <img class="img-fluid mx-auto d-block char-5"
					 alt="qwixx-char" width="105" height="340"/></h4>
					<div class="card-body">
						...
						<button class="btn btn-square btn-danger red-lock5" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-warning yellow-lock5" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-success green-lock5" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-primary blue-lock5" data-toggle="button"><i class="fa fa-lock"></i></button>
