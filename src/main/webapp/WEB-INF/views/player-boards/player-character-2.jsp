<!-- PLAYER 2 -->
			<div class="col-sm-6">
				<div class="card text-center">
					<h4 class="card-title card-title-bold">Player 2 <img class="img-fluid mx-auto d-block char-2"
					...
					<div class="card-body">
						...
						<button class="btn btn-square btn-danger red-lock2" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-warning yellow-lock2" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-success green-lock2" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-primary blue-lock2" data-toggle="button"><i class="fa fa-lock"></i></button>
