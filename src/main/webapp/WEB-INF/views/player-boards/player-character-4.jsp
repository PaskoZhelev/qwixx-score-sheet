<!-- PLAYER 4 -->
			<div class="col-sm-6">
				<div class="card text-center">
					<h4 class="card-title card-title-bold">Player 4 <img class="img-fluid mx-auto d-block char-4"
					...
					<div class="card-body">
						...
						<button class="btn btn-square btn-danger red-lock4" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-warning yellow-lock4" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-success green-lock4" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-primary blue-lock4" data-toggle="button"><i class="fa fa-lock"></i></button>
