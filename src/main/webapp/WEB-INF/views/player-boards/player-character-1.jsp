<!-- PLAYER 1 -->
			<div class="col-sm-6">
				<div class="card text-center">
					<h4 class="card-title card-title-bold">Player 1 <img class="img-fluid mx-auto d-block char-1"
					...
					<div class="card-body">
						...
						<button class="btn btn-square btn-danger red-lock" data-toggle="button"><i class="fa fa-lock"></i></button>
						...
						<button class="btn btn-square btn-warning yellow-lock" data-toggle="button"><i class="fa fa-lock"></i></button>
